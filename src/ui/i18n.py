...
_STRINGS["en"] = {
    ...
    "btn_save_location": "💾 Save Current Place",
    "location_panel_hint": "Use the current map click or manual coordinates, then save it here.",
...
_STRINGS["zh_TW"] = {
    ...
    "btn_save_location": "💾 儲存目前地點",
    "location_panel_hint": "使用剛點擊的地圖位置或手動座標，然後在這裡儲存。",
