...
_STRINGS["en"] = {
    ...
    "btn_speed_preset_walk": "Walk",
    "btn_speed_preset_bike": "Bike",
    "btn_speed_preset_drive": "Drive",
    "btn_motion_settings": "Motion Settings",
    ...
    "route_info": "Points: {points} | Distance: {distance} | ETA: {eta}",
    "route_eta_empty": "--",
    "route_remaining_empty": "Remaining ETA appears while moving to a destination.",
    "route_remaining_done": "Remaining: 0 m | ETA: <1 min",
    "route_total_info": "Total route: {distance} | Full ETA: {eta}",
    "motion_settings_title": "Motion Settings",
    "motion_noise_label": "Speed Noise",
    "motion_random_stop_label": "Random Temporary Stops",
    "motion_stop_interval_label": "Average stop interval (m)",
    "motion_stop_min_label": "Min stop duration (s)",
    "motion_stop_max_label": "Max stop duration (s)",
    "motion_displacement_label": "Displacement Noise",
    "motion_displacement_radius_label": "Max displacement radius (m)",
    "motion_noise_help": "Adds small natural speed variation so movement feels less mechanical.",
    "motion_random_stop_help": "Sometimes pauses briefly during route walking, like waiting at a light.",
    "motion_stop_interval_help": "Controls how often a short stop may happen while moving.",
    "motion_stop_min_help": "Shortest time a random stop can last.",
    "motion_stop_max_help": "Longest time a random stop can last.",
    "motion_displacement_help": "Adds gentle wandering around the route instead of following a perfectly rigid line.",
    "motion_displacement_radius_help": "Sets how far that gentle wandering is allowed to drift from the route.",
    "motion_settings_invalid_title": "Invalid Motion Settings",
    "motion_settings_invalid_msg": "Please enter valid numbers for all motion settings.",
    "btn_cancel": "Cancel",
    # --- Route Storage ---
...
_STRINGS["zh_TW"] = {
    ...
    "speed_label": "移動速度：",
    "noise_label": "速度噪音：",
    "btn_speed_preset_walk": "步行",
    "btn_speed_preset_bike": "騎車",
    "btn_speed_preset_drive": "開車",
    "btn_motion_settings": "移動設定",
    "btn_calc_route": "🗺 規劃路線",
    "btn_start": "▶ 開始",
    "btn_pause": "⏸ 暫停",
    "btn_stop": "⏹ 停止",
    ...
    "route_info": "路點：{points} | 距離：{distance} | 預估時間：{eta}",
    "route_eta_empty": "--",
    "route_remaining_empty": "開始移動後，這裡會顯示剩餘距離與剩餘時間。",
    "route_remaining_done": "剩餘：0 m | 預估還要：<1 分鐘",
    "route_total_info": "全程：{distance} | 全程預估：{eta}",
    "motion_settings_title": "移動設定",
    "motion_noise_label": "速度噪音",
    "motion_random_stop_label": "隨機短暫停留",
    "motion_stop_interval_label": "平均每幾公尺可能停一次",
    "motion_stop_min_label": "最短停留秒數",
    "motion_stop_max_label": "最長停留秒數",
    "motion_displacement_label": "位移噪音",
    "motion_displacement_radius_label": "最大位移半徑（公尺）",
    "motion_noise_help": "讓移動速度有一點自然變化，看起來不會太死板。",
    "motion_random_stop_help": "在路線移動時偶爾短暫停一下，像在等紅燈。",
    "motion_stop_interval_help": "控制移動時大概多久可能出現一次短暫停留。",
    "motion_stop_min_help": "每次隨機停留最短會停多久。",
    "motion_stop_max_help": "每次隨機停留最長會停多久。",
    "motion_displacement_help": "讓路線會有一點自然微晃，不會像沿著死板直線在走。",
    "motion_displacement_radius_help": "控制這種微晃最多可以離主路線多遠。",
    "motion_settings_invalid_title": "移動設定無效",
    "motion_settings_invalid_msg": "請輸入有效的移動設定數值。",
    "btn_cancel": "取消",
    # --- Route Storage ---
