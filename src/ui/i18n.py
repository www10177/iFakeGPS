...
_STRINGS["en"] = {
    ...
    "btn_save_location": "Select on Map",
    "btn_cancel_save_location": "Cancel Selection",
    "btn_save_current_position": "Save Current GPS",
    "location_panel_hint": "Select a place on the map to save it, or save the current simulated GPS position.",
...
_STRINGS["zh_TW"] = {
    ...
    "btn_save_location": "選取地點儲存",
    "btn_cancel_save_location": "取消選取",
    "btn_save_current_position": "儲存目前 GPS",
    "location_panel_hint": "在地圖上選取要儲存的地點，或直接儲存目前模擬中的 GPS 位置。",
